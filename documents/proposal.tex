...
if a robot is going to affect the world it must have an understanding of the posisitions
...
The system we have outlined abstracts the detector from the classifier by taking the notion 
of Objectness and extending it to a global framework in a way that allows new detectors 
for local properties to be incorporated seamlessly and without down time.  Our technology 
will enable robots to help people by robustly sensing and manipulating the objects that people value most.
...
useful employment. I would like to pursue that goal by better understanding game playing, 
