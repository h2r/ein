...
the object and tracking its successes and failures.  The robot
performs best arm identification in the N-armed bandit problem by
using a policy that computes confidence bounds while incorporating
prior information, enabling it to quickly find a near optimal arm
without pulling all the arms as in UCB-based approaches.  We
demonstrate that our adaptation step significantly improves accuracy
over a non-adaptive system, enabling a robot to improve grasping
