...
is time consuming and can be difficult for a non-expert to perform ~\citep{}. There 
...
highest accuracy or precision ~\citep{}.
...
a per object basis. It is portable, convenient, and general because the expert knowledge it employs
...
object and the the second part is estimating the pose of the object, both of which we 
