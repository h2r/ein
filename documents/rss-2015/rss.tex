...
\begin{table}
  ...
  \begin{tabular}{lr}
    ...
    $Y$  & Observations \\
    $D \subset X \times Y$  & Universe of Observations \\
    \mbox{$\{T_i\}_{i \in \mathbb{N}}$}  & Sequence of Training Sets \\
    $\mathcal{T}$ is the power set of $D$  & All Possible Training Sets \\
    \mbox{$O: \mathcal{T} \to \mathbb{R}$} & Objective Function \\
    \mbox{$S: \mathbb{N} \to \mathbb{R}$}  & Objective Function History \\
    $\mathcal{S}$  & All Possible Objective Function Histories \\
    \mbox{$H: \mathcal{S} \times \mathbb{N} \to \{0,1\}$}  & Help Criterion \\
    \mbox{$\mathcal{C} = \mathcal{T} \times \mathcal{S} \times \mathbb{N}$}  & Complete Training Set \\
    \mbox{$G: \mathcal{C}$}  & Help Request \\
    \mbox{$P: \mathcal{C} \to \{0,1\}$}  & Stopping Criterion \\
    \mbox{$L: \mathcal{C} \to D$}  & Sample Proposal \\
  \bottomrule
  \end{tabular}
  \end{center}
\end{table}
